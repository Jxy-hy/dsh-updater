...
export const zh = {
  ...
  'neverChecked': '尚未检查过',
  'updatedAt': '上次检查：{time}（{age}）',
  'justNow': '刚刚',
  'minutesAgo': '{n} 分钟前',
  'hoursAgo': '{n} 小时前',
  'daysAgo': '{n} 天前',
  'staleData': '版本数据已缓存超过 30 分钟，可能已过期——点击「检查更新」刷新',
  'checkNow': '检查更新',
  'checkingNow': '正在检查…',
  'update': '更新到最新',
...
export const en = {
  ...
  'updatedAt': 'Last checked: {time} ({age})',
  'justNow': 'just now',
  'minutesAgo': '{n} min ago',
  'hoursAgo': '{n} h ago',
  'daysAgo': '{n} d ago',
  'staleData': 'Version data is cached for over 30 minutes and may be stale — click "Check for updates" to refresh',
